...
const LEGAL_T = {
  de: {
    ...
    'prv.datasafety.p1': 'Die eigentlichen Inhalte (Transaktionen, Budgets, Belege, Profil) werden <strong>ausschließlich lokal</strong> verarbeitet und nicht an Server übermittelt. Über die Abo-Verwaltung <strong>RevenueCat</strong> (siehe 6.6) werden jedoch Kauf-/Abo-Daten sowie eine App-/Geräte-Kennung erhoben und an RevenueCat weitergegeben. Im Google Play Data Safety Formular ist daher anzugeben: <em>Käufe (Purchase history)</em> und <em>App-/Geräte-IDs (Device or other IDs)</em> = „erhoben" und „geteilt"; Verschlüsselung bei der Übertragung = „ja"; Löschung auf Anfrage = „ja". Alle übrigen Kategorien (Finanzinhalte, Name/Gehalt, Fotos, Standort) = „keine Daten erhoben".',
    'prv.datasafety.tbl': '<table class="legal-table"><thead><tr><th>Datenkategorie</th><th>Erhoben?</th><th>Weitergegeben?</th></tr></thead><tbody><tr><td>Finanzdaten (Transaktionen, Budgets, Belege)</td><td>Nein — nur lokal</td><td>Nein</td></tr><tr><td>Personendaten (Name, Gehalt)</td><td>Nein — nur lokal</td><td>Nein</td></tr><tr><td>Fotos (Beleg-Scanner)</td><td>Nein — on-device OCR, kein Speichern</td><td>Nein</td></tr><tr><td>Standortdaten</td><td>Nein</td><td>Nein</td></tr><tr><td>App-/Geräte-Kennung (RevenueCat App-Nutzer-ID)</td><td>Ja — via RevenueCat</td><td>Ja — an RevenueCat (USA)</td></tr><tr><td>Kauf-/Abo-Daten (RevenueCat)</td><td>Ja — via RevenueCat</td><td>Ja — an RevenueCat (USA)</td></tr><tr><td>Zahlungsdaten (Google Play Billing)</td><td>Google, nicht TapFlow</td><td>—</td></tr></tbody></table>',
  ...
  en: {
    ...
    'prv.h9':          '9. Google Play — Data Safety',
    'prv.datasafety.p1': 'The actual content (transactions, budgets, receipts, profile) is processed <strong>exclusively locally</strong> and is not transmitted to any server. However, the subscription service <strong>RevenueCat</strong> (see 6.6) collects purchase/subscription data and an app/device identifier and shares them with RevenueCat. In the Google Play Data Safety form this must be declared as: <em>Purchase history</em> and <em>Device or other IDs</em> = "collected" and "shared"; encrypted in transit = "yes"; deletion on request = "yes". All other categories (financial content, name/salary, photos, location) = "no data collected".',
    'prv.datasafety.tbl': '<table class="legal-table"><thead><tr><th>Data category</th><th>Collected?</th><th>Shared?</th></tr></thead><tbody><tr><td>Financial data (transactions, budgets, receipts)</td><td>No — local only</td><td>No</td></tr><tr><td>Personal data (name, salary)</td><td>No — local only</td><td>No</td></tr><tr><td>Photos (receipt scanner)</td><td>No — on-device OCR, not stored</td><td>No</td></tr><tr><td>Location data</td><td>No</td><td>No</td></tr><tr><td>App/device identifier (RevenueCat app user ID)</td><td>Yes — via RevenueCat</td><td>Yes — to RevenueCat (USA)</td></tr><tr><td>Purchase/subscription data (RevenueCat)</td><td>Yes — via RevenueCat</td><td>Yes — to RevenueCat (USA)</td></tr><tr><td>Payment data (Google Play Billing)</td><td>Google, not TapFlow</td><td>—</td></tr></tbody></table>',
